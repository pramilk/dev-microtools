...
whatIsIt: >-
  ...
  type, with a visual gallery of thirty starter examples — a live-rendered thumbnail per
  ...
  Ishikawa/fishbone, swimlane, Venn, Wardley map) and even syntax railroad diagrams for ABNF,
  EBNF and PEG grammars. Each example is paired with its own row of one-click "Insert" snippet
